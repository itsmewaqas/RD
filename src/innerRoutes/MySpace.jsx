...
function MySpace(props) {
  ...
  const [colDefs, setColDefs] = useState([
    {
      ...
      cellRenderer: (row) => {
        ...
        return <a onClick={() => navigate(`/ReportGenerationView`)}
  ...
  return (
    <div>
      ...
      {reportCreate && <CreateReport reportCreate={reportCreate} setReportCreate={setReportCreate} buttonCtrl={console.log('test')} />}
